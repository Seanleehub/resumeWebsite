...
<meta name="description" content="sean lee web design resume site php results" />
                             ...
                             <div id="headercontainer">       	 <div id="contentheader">
                                                <div id="contentheadercontent"><img src="images/portfolioheader.png" alt="homepageheader"/></div>
                            						...
                            						<div id="leftcontent">
                                                      ...
                                                      <p>Below is the results from the query</p>
                                                      <p>
<?php
...
$connect = mysql_connect("sql204.byethost10.com","b10_2635369","hockey");

//connect to the database

$db=mysql_select_db("b10_2635369_details",$connect);
...
print "<table id=\"blah\" border=1 width=\"100%\">";
print "<tr bgcolor=\"red\"><td>Id</td>
		<td>Name</td>
		<td>Date Of Birth</td>
		<td>Sex</td>
		<td>Street</td>
...
?>
                                                      ...
                                                      <div align="right"><a href="sql.html" title="Click here to go back to SQL examples">Click here to go back to SQL examples...             
            ...
            <li><a href="webdevelopment.html">Web Development</a></li>
                                            ...
                                            <li><a href="phpexample.php">PhP</a></li>
                                            <li><a href="sql.html" class="style7">SQL</a></li>
                                            <li><a href="fireworks.html">Fireworks</a><a href="user.html"></a></li>
                                            <li><a href="tech.html">Technical Documentation</a></li>
                                          
                                            <li><a href="fireworks.html"></a><a href="user.html">User Documentation</a></li>
